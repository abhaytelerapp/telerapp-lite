...
function loadWriteSEG() {
    ...
    span.innerHTML =
        ...
        <img class="img SEG" alt="eraseSEG" id="eraseSEG" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/b_Eraser.png" width="30" height="30" style="display:none;" >
        ...
        <img class="img SEG" alt="UndoSEG" id="UndoSEG" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/b_Undo.png" width="30" height="30" style="display:none;" >
        <img class="img SEG" alt="RedoSEG" id="RedoSEG" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/b_Redo.png" width="30" height="30" style="display:none;" >

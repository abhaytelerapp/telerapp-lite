...
function loadVR2() {
    ...
    span.innerHTML =
        ...
        <img class="img VR2" alt="saveVR2" id="saveVR2" onmouseover="onElementOver(this);" onmouseleave="onElementLeave();" src="../image/icon/lite/download.png" width="30" height="30" style="display:none;" >`;
    addIconSpan(span);

...
export const fetchUsers = async (apiData) => {
...
export const fetchReportSetting = (apiData, groupName) => {
  return fetch(
    `${apiData}/reports-setting-by-study?groupName=${groupName}`
  ).then((response) => response.json());
};
...
export const createPatientReports = async (
  apiData,
  patientDetail,
  setReportData,
  username,
...
export const updatePatientReports = async (
  apiData,
  id,
  patientDetail,
  setReportData,
...
export const fetchPatientReportsById = async (id, apiData) => {
  return fetch(`${apiData}/reportsById/${id}`).then((response) =>
    response.json()
  );
};
...
export const fetchDocumentUploadForStudy = async (
  apiData,
  studyInstanceUid
) => {
  try {
...
export const createDocument = async (
  ...
  try {
    ...
    await fetchDocumentUpload(apiData, studyInstanceUid)
      .then((data) =>
        setDocumentUploadDetails([...documentUploadDetails, data])
      )
      .catch((error) =>
        console.error("Error fetching document upload details:", error)
      );
...
export const updateDocument = async (
  ...
  const documentData =
    documentUploadDetails &&
    documentUploadDetails.filter((data) => data.id !== id);
...
export const deleteDocumentUrl = async (
  apiData,
  id,
  updateData,
  setDocumentUploadDetails,
...
export const fetchEditorPatientReportData = (apiData, studyInstanceUid) => {
  return fetch(
    `${apiData}/editor_patientData?StudyInstanceUID=${studyInstanceUid}`
  )
    .then((response) => {
      if (!response.ok) {
        throw new Error("Failed to fetch patient report");
...
export const fetchInstitutionPromptAccess = async (institution, apiData) => {
...
export const genAiRadiologyReporter = async (apiData, data) => {
...
export const updateOrthancStudy = async (apiData, aianalysis, studyInstanceUid) => {

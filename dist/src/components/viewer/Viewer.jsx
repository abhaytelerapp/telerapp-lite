          ...
          <span id="icon-list">
            ...
            <span className="WindowRevisionParent">
              ...
              >
                ...
                <div className="WindowSelect" id="WindowBrain" wc="40" ww="80">
                  Brain(40,80)
                </div>
                <div className="WindowSelect" id="WindowChest" wc="40" ww="400">
                  Chest(40,400)
                </div>
                <div
                  className="WindowSelect"
